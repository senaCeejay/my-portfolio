...
const Hero = () => {
    return (
        <>
            <div className='mt-[70px] text-center lg:text-left flex items-center w-full flex-col lg:flex-row md:justify-center md:gap-10 lg:gap-0 lg:justify-between p-4'>
                <div className='mt-2'>
                    <div className=''>
